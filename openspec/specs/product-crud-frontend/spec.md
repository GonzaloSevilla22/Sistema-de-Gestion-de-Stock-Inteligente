# Capability: product-crud-frontend

## Purpose

Provides the React frontend for product management: a product list page at `/products` with search filtering and stock status chips, plus create, edit, and delete operations backed by the product REST API.
