...
Gestión de movimientos de stock: registro de entradas y salidas de productos, con actualización automática del stock del producto en la misma transacción, y consulta del historial completo de movimientos.
