# Spec: stock-movement-model

## Purpose

Defines the `StockMovement` SQLAlchemy 2.0 ORM model, its mapped columns, database indexes, the FK relationship to `Product`, and the `MovementType` Python Enum.
