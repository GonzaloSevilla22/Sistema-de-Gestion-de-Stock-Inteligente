# Capability: stock-movement-frontend

## Purpose

Provides the React frontend for stock movement management: a movements list page at `/movements` showing all movements ordered by date descending with color-coded ENTRADA/SALIDA badges, plus a form to register new movements backed by the movements REST API.
